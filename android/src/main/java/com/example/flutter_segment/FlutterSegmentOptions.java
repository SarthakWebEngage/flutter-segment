...
public class FlutterSegmentOptions {
    ...
    public  FlutterSegmentOptions(
            ...
            Boolean webEngageIntegrationEnabled,
            Boolean debug
    ) {
    ...
    static FlutterSegmentOptions create(Bundle bundle) {
        ...
        return new FlutterSegmentOptions(writeKey, trackApplicationLifecycleEvents, isAmplitudeIntegrationEnabled,
                isAppsflyerIntegrationEnabled, isWebEngageIntegrationEnabled, debug);
    }
    ...
    static FlutterSegmentOptions create(HashMap<String, Object> options) {
        ...
        Boolean isWebEngageflyerIntegrationEnabled = orFalse((Boolean) options.get("webengageIntegrationEnabled"));
        Boolean debug = orFalse((Boolean) options.get("debug"));
        return new FlutterSegmentOptions(writeKey, trackApplicationLifecycleEvents, isAmplitudeIntegrationEnabled,
                isAppsflyerIntegrationEnabled, isWebEngageflyerIntegrationEnabled, debug);
    }
